...
module ConvoyApi
  class DatastoreEventStatus
    ProcessingStatus = "Processing".freeze
    FailureStatus = "Failure".freeze
    ...
    def build_from_hash(value)
      return value if DatastoreEventStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DatastoreEventStatus"
    end
  end
end
